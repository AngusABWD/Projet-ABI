        ...
        <header class="container px-0 mt-3">
            ...
            <nav class="menu navbar navbar-expand d-none d-md-block">
                <ul class="navbar-nav d-flex justify-content-around">
                    ...
                    <li class="nav-item <?php global $headerActive;
                                        if ($headerActive == 'home') : ?> active <?php endif ?>">
                        <a class="nav-link" href="home">Accueil</a>
                    </li>
                    <li class="nav-item <?php global $headerActive;
                                        if ($headerActive == 'ABIgroup') : ?>  active <?php endif ?>">
                        <a class="nav-link" href="ABIgroup">La Société</a>
                    </li>
                    <li class="nav-item <?php global $headerActive;
                                        if ($headerActive == 'actuality') : ?>  active <?php endif ?>">
                        <a class="nav-link" href="actuality">Actualités</a>
                    </li>
                    <li class="nav-item <?php global $headerActive;
                                        if ($headerActive == 'offer') : ?>  active <?php endif ?>">
                        <a class="nav-link" href="offer">Nos Services</a>
                    </li>
                    <li class="nav-item <?php global $headerActive;
                                        if ($headerActive == 'contact') : ?>  active <?php endif ?>">
